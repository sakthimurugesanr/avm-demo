  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ── Image ── */}
        {/* <div
          className={`transition-transform duration-300 cursor-zoom-in ${zoomed ? "scale-150 cursor-zoom-out" : "scale-100"}`}
          onClick={toggleZoom}
        >
          <img
            src={images[index]}
            alt={`Work ${index + 1}`}
            className="max-h-[80vh] max-w-[90vw] sm:max-w-[80vw] rounded-xl object-contain shadow-2xl select-none"
            draggable={false}
          />
        </div> */}
        <div
